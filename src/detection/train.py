...
def parse_args():
    ...
    parser.add_argument("--config", type=str, default="configs/detection_config.yaml", help="Path to configuration file")
    parser.add_argument("--data", type=str, default="data/dataset.yaml", help="Path to dataset configuration")
